...
class Sala1:
    def __init__(self):
        self.sala1 = pygame.display.set_mode((1280, 720))
        ...
        self.holly = Holly(950, self.sala1.get_height()-80,1, 4, 4)
    ...
    def loop_principal(self):
        ...
        while run:
            ...
            self.sala1.fill(self.fundo)

            self.sala1.blit(self.chao, self.chao_rect.topleft)

            self.sala1.blit(self.mesa1, self.mesa1_rect.topleft)
            self.sala1.blit(self.mesa2, self.mesa2_rect.topleft)
            self.sala1.blit(self.mesa3, self.mesa3_rect.topleft)
            self.sala1.blit(self.mesa4, self.mesa4_rect.topleft)

            self.holly.desenha(self.sala1)
